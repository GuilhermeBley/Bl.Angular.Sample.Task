...
- Create Angular project with ng: `ng new bl.angular.sample.task.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bl.angular.sample.task.client.esproj`).
